...
import type { LandingPagePlayerProps } from './landing-page-player.types';
...
export default function LandingPagePlayer(props: LandingPagePlayerProps) {
  ...
  return (
    <div
      data-testid="landing-page-player"
      ref={videoRef}
      className={cn(css.Player, {
    ...
    >
      {isVideClicked ? (
        <iframe
          data-testid="landing-page-player-frame"
          allowFullScreen
          allow="autoplay"
          src={generateURL(id)}
          className={css.Frame}
        ...
        <Fragment>
          <a
            data-testid="landing-page-player-link"
            ref={videoLinkRef}
          ...
          >
            <picture>
              <source
                data-testid="landing-page-player-source"
                srcSet={`https://i.ytimg.com/vi_webp/${videoId}/maxresdefault.webp`}
                type="image/webp"
              />
              <img
                data-testid="landing-page-player-image"
                ref={videoMediaRef}
