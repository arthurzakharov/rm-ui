      ...
      condition: {
        ...
        form: {
          q17347: [
            {
              value:
                'Befristetes Aufenthaltsrecht>>>OR>>>Unbefristetes Aufenthaltsrecht / Niederlassungserlaubnis>>>OR>>>Sonstiges',
              extra: null,
            },
          ],
        },
      ...
      condition: {
        ...
        form: {
          q17347: [
            {
              value:
                '>>>NOT>>>Befristetes Aufenthaltsrecht>>>NOT>>>Einbürgerung>>>NOT>>>Unbefristetes Aufenthaltsrecht / Niederlassungserlaubnis>>>NOT>>>Sonstiges',
              extra: null,
            },
          ],
        },
  ...
  successBox: {
    head: [
      ...
      },
      {
        variationId: 4,
        content: {
          primary: 'Vielen Dank für Ihre Anfrage bei PassExperten',
          secondary: '',
        },
        condition: null,
      },
    ...
    body: {
      title: [
        ...
        },
        {
          variationId: 4,
          content:
            'Um eine abschließende Einschätzung vornehmen zu können, benötigen wir weiterführende Informationen. Ein Antrag könnte sich lohnen.',
          condition: null,
        },
      ],
      html: [
        ...
        },
        {
          variationId: 4,
          content:
            '<div style="margin-top: -8px; margin-bottom: 16px; line-height: 24px; font-weight:300;">Ihr Anliegen ist uns wichtig, daher werden wir Ihre Anfrage umgehend bearbeiten.</div><div style="margin-bottom: 16px line-height: 24px; font-weight:300;">Ein Experte wird sich zeitnah telefonisch bei Ihnen melden, Ihnen sagen, ob die Chancen für Sie gut stehen und alle weiteren Schritte mit Ihnen besprechen. Und das Beste: <bold>Das Gespräch ist völlig kostenlos!</bold></div><div style="margin-top: 16px; line-height: 24px; font-weight:300;">Mit freundlichen Grüßen</br>Ihr Passexperten Team</div>',
          condition: {
            forceResult: 'none',
            mode: 'some',
            screen: null,
            form: {
              q17347: [
                {
                  value: 'Unbefristetes Aufenthaltsrecht / Niederlassungserlaubnis>>>OR>>>Sonstiges',
                  extra: null,
                },
              ],
            },
          ...
          condition: {
            ...
            form: {
              q17347: [
                {
                  value:
                    '>>>NOT>>>Einbürgerung>>>NOT>>>Unbefristetes Aufenthaltsrecht / Niederlassungserlaubnis>>>NOT>>>Sonstiges',
                  extra: null,
                },
              ],
            },
          ...
          content: {
            ...
            content: [
              ...
              },
              {
                type: 'exclamation',
                content:
                  '<span>Aufenthalt in Deutschland:</span> Es sieht aus als würden Sie nicht die benötigten fünf Jahre Aufenthalt in Deutschland erfüllen.<br>Mögliche Ausnahmen können sein:<ol><li style="margin-top:16px;"><strong>Deutscher Ehepartner?</strong> <a href="https://passexperten.de/ratgeber/erleichterte-einbuergerung/" target="_blank">Lesen Sie hier die Voraussetzungen der Einbürgerung nach</a>.</li><li style="margin-top:16px;"><strong>Seit 3 Jahren in Deutschland?</strong> Sie sind besonders gut integriert und können Deutsch auf einem C1-Niveau? Dann <a href="https://passexperten.de/ratgeber/erleichterte-einbuergerung/" target="_blank">lesen Sie hier die Voraussetzungen</a></li><li style="margin-top:16px;">Es können in besonderen Ausnahmefällen auch weitere Ausnahmen greifen.</li></ol>',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              {
                type: 'check',
                content: '<span>Aufenthaltstitel:</span> Ihr Aufenthaltstitel ist für die Einbürgerung ausreichend.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
                  ...
                  form: {
                    q17356: [
                      {
                        value: 'Unbefristetes Aufenthaltsrecht>>>OR>>>EU-Bürger',
                        extra: null,
                      },
                    ],
                  },
              ...
              },
              {
                ...
                condition: {
                  ...
                  form: {
                    q17356: [
                      {
                        value: 'Befristetes Aufenthaltsrecht',
                        extra: {
                          mode: 'every',
                          condition: [
                            {
              ...
              },
              {
                type: 'exclamation',
                content:
                  '<span>Duldung:</span> Eine Duldung ist kein geeigneter Aufenthaltstitel für die Einbürgerung. Prüfen Sie, ob Sie die Voraussetzungen für eine Aufenthaltserlaubnis erfüllen, da diese für eine Einbürgerung erforderlich ist.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              },
              {
                type: 'exclamation',
                content:
                  '<span>Aufenthaltstitel:</span> Ihr Aufenthaltstitel könnte für die Einbürgerung nicht ausreichen. Prüfen Sie, ob Sie die Voraussetzungen für eine Aufenthaltserlaubnis erfüllen, da diese für eine Einbürgerung erforderlich ist.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              },
              {
                type: 'check',
                content:
                  '<span>Ausbildung:</span> Ihre Ausbildung in Deutschland ist hoch genug für die notwendigen Integrationsvoraussetzungen.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              },
              {
                type: 'question',
                content:
                  '<span>Ausbildung:</span> Sie haben eine deutsche Ausbildung absolviert. Diese reicht für die Einbürgerung nur, wenn:<ul><li style="margin-top:12px;">Sie zuvor einen Abschluss der 9. Klasse, 10. Klasse oder das Abitur in Deutschland gemacht haben.</li><li style="margin-top:12px; margin-bottom:12px;">Ihre Ausbildung Kurse in Politik, Verwaltungswissenschaften, Sozialwissenschaften, Rechtswissenschaften oder Gesellschaftskunde enthält.</li></ul> Falls Ihr Abschluss nicht ausreicht, empfiehlt es sich, den Einbürgerungstest nachzuholen.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              },
              {
                type: 'exclamation',
                content:
                  '<span>Einbürgerungstest:</span> Es ist fraglich, ob Sie die notwendingen Integrationsvoraussetzungen besitzen. Fehlt der Einbürgerungstest bestehen zwei Möglichkeiten:<ol><li style="margin-top:16px;">Es greifen Ausnahmen. <a href="https://passexperten.de/ratgeber/einbuergerung-voraussetzungen/#Deutschkenntnisse" target="_blank">Gängige Ausnahmen finden Sie hier</a>.</li><li style="margin-top:16px;">Sie können den Einbürgerungstest nachholen.</li></ol>',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
                    ...
                    q17370: [
                      {
                        ...
                        extra: {
                          ...
                          condition: [
                            {
                              value:
                                '>>>NOT>>>9. Klasse Abschluss>>>NOT>>>10. Klasse Abschluss>>>NOT>>>Ausbildung>>>NOT>>>Abitur oder Fachabitur>>>NOT>>>Studium',
                            },
                          ],
                        },
                      },
              ...
              },
              {
                type: 'exclamation',
                content:
                  '<span>Gesicherter Lebensunerhalt:</span> Sie beziehen derzeit Bürgergeld. Damit ist eine Einbürgerung sehr schwierig. Mögliche Ausnahmen können Sie <a href="https://passexperten.de/news/einbuergerung-buergergeld/" target="_blank">hier nachlesen</a>.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              },
              {
                type: 'question',
                content:
                  '<span>Gesicherter Lebensunerhalt:</span> Sollten Sie derzeit Bürgergeld beziehen wäre eine Einbürgerung sehr schwierig. Mögliche Ausnahmen können Sie <a href="https://passexperten.de/news/einbuergerung-buergergeld/" target="_blank">hier nachlesen</a>.',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
              ...
              },
              {
                type: 'exclamation',
                content:
                  '<span>Pass oder Passersatz:</span> Sie können derzeit auf keinen gültigen Pass oder Passersatz zurückgreifen.<ol><li style="margin-top:16px;">Sollte es Ihnen möglich sein beantragen Sie einen gültigen Pass Ihres Heimatlandes.</li><li style="margin-top:16px;">Eine Einbürgerung ist auch gut mit einem Passersatz möglich. Dazu sollten in Ihrem Passeratz allerdings nicht stehen, dass die Angaben "auf eigenen Angaben" beruhen.</li><li style="margin-top:16px;">Haben Sie weder die Möglichkeit einen Pass oder Passersatz vorliegen, ist auch eine Einbürgerung mit anwaltlicher Unterstützung möglich.</li></ol>',
                subContent: [],
                condition: {
                  forceResult: 'none',
                  mode: 'some',
