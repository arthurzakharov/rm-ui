...
export const generateStyleTag = (source: CSSStyleDeclaration, className: string): string => {
  const cssVariableNames = [
    ...
    '--calendar-modal-button-selected-text',
    '--calendar-modal-horizontal-padding',
    '--calendar-modal-vertical-padding',
    '--calendar-modal-font-size',
    '--calendar-modal-line-height',
    '--calendar-modal-button-size',
    '--calendar-modal-button-gap',
